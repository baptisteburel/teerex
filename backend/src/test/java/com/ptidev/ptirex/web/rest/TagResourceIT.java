...
import com.ptidev.ptirex.domain.Tag;
import com.ptidev.ptirex.domain.enumeration.TagNames;
import com.ptidev.ptirex.repository.TagRepository;
...
class TagResourceIT {
    ...
    private static final TagNames DEFAULT_TAG_NAME = TagNames.ENERGIE;
    private static final TagNames UPDATED_TAG_NAME = TagNames.EMISSION;
