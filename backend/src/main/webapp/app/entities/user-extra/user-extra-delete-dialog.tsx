...
export const UserExtraDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ptiRexApp.userExtra.delete.question">Are you sure you want to delete this UserExtra?</ModalBody>
      <ModalFooter>
