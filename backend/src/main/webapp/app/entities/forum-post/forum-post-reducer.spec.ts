...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORUMPOST_LIST actions', async () => {
    ...
    it('dispatches FETCH_FORUMPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FORUMPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FORUMPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FORUMPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FORUMPOST actions', async () => {
      const expectedActions = [
        {
