  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ptiRexApp.company.home.createOrEditLabel" data-cy="CompanyCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Mail Contact" id="company-mailContact" name="mailContact" data-cy="mailContact" type="text" />
              <ValidatedField label="Numero Contact" id="company-numeroContact" name="numeroContact" data-cy="numeroContact" type="text" />
              <ValidatedField
                label="Url Site Vitrine"
                id="company-urlSiteVitrine"
                name="urlSiteVitrine"
                data-cy="urlSiteVitrine"
                type="text"
              />
