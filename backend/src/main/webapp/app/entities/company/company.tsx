          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('mailContact')}>
                  Mail Contact <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('numeroContact')}>
                  Numero Contact <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('urlSiteVitrine')}>
                  Url Site Vitrine <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {companyList.map((company, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{company.mailContact}</td>
                  <td>{company.numeroContact}</td>
                  <td>{company.urlSiteVitrine}</td>
