...
import com.ptidev.ptirex.service.UserExtraService;
...
/**
 * REST controller for managing {@link com.ptidev.ptirex.domain.UserExtra}.
 */
@RestController
@RequestMapping("/api")
public class UserExtraResource {
    ...
    public ResponseEntity<UserExtra> updateUserExtra(
        ...
        UserExtra result = userExtraService.update(userExtra);
        return ResponseEntity
            .ok()
