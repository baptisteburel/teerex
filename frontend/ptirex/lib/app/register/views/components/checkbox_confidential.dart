...
class CheckboxConfidential extends StatelessWidget {
  const CheckboxConfidential({required this.controller, Key? key})
      : super(key: key);
      ...
      text: TextSpan(children: [
        WidgetSpan(
          ...
          child: Obx(() => Checkbox(
                ...
                value: controller.isConfidentialChecked.value,
                onChanged: (value) => {controller.updateConfidential()},
              )),
        ),
        TextSpan(
          text: "J'accepte la",
          recognizer: TapGestureRecognizer()
            ..onTap = () => controller.updateConfidential(),
            ...
            ..onTap = (() => Get.defaultDialog(
                  ...
                  content: Flexible(
                    child: SingleChildScrollView(
                      child: RichText(
                          text: TextSpan(text: """Politique de confidentialité
ARTICLE 1 : PRÉAMBULE  
...
Le site  est hébergé par :  quelqu'un
...
Les données à caractère personnelles sont collectées par quelqu'un, au capital d'un certain montant, dont le numéro d’immatriculation est inconnu.  
Le responsable du traitement des données à caractère personnel peut être contacté de la manière suivante :  
Par courrier à l’adresse :  quelque part ;  
Par téléphone, au numéro de téléphone ;  
Par mail : un email.  

Article 4.2 : Le délégué à la protection des données  

Le délégué à la protection des données de l’entreprise ou du responsable est à définir. 
...
Pour exercer vos droits, veuillez adresser votre  mail au délégué.
...
La présente politique, éditée le 25/06/2022, a été mise à jour le 25/06/2022.
""")),
                    ),
                  ),
                )),
